...
public class VerifyApi {
     ...
     */
    public okhttp3.Call verifyMatchPostCall(MultiFieldReq multiFieldReq, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/verify.match";
    ...
    private okhttp3.Call verifyMatchPostValidateBeforeCall(MultiFieldReq multiFieldReq, final ApiCallback _callback) throws ApiException {
        return verifyMatchPostCall(multiFieldReq, _callback);
    ...
    public MatchResponse verifyMatchPost(MultiFieldReq multiFieldReq) throws ApiException {
        ApiResponse<MatchResponse> localVarResp = verifyMatchPostWithHttpInfo(multiFieldReq);
    ...
    public ApiResponse<MatchResponse> verifyMatchPostWithHttpInfo(MultiFieldReq multiFieldReq) throws ApiException {
        okhttp3.Call localVarCall = verifyMatchPostValidateBeforeCall(multiFieldReq, null);
     ...
     */
    public okhttp3.Call verifyMatchPostAsync(MultiFieldReq multiFieldReq, final ApiCallback<MatchResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifyMatchPostValidateBeforeCall(multiFieldReq, _callback);
        Type localVarReturnType = new TypeToken<MatchResponse>(){}.getType();
