...
public class V3VerifySignalsPost200Response extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(V3VerifySignalsPost200Response.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!V3VerifySignalsPost200Response.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'V3VerifySignalsPost200Response' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<V3VerifySignalsPost200Response>() {
                @Override
                public void write(JsonWriter out, V3VerifySignalsPost200Response value) throws IOException {
                ...
                @Override
                public V3VerifySignalsPost200Response read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        V3VerifySignalsPost200Response ret = new V3VerifySignalsPost200Response();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for V3VerifySignalsPost200Response: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public V3VerifySignalsPost200Response() {
        super("oneOf", Boolean.FALSE);
    }

    public V3VerifySignalsPost200Response(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return V3VerifySignalsPost200Response.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to V3VerifySignalsPost200Response
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for V3VerifySignalsPost200Response with oneOf schemas: SignalsResponseV0, SignalsResponseV20240424. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of V3VerifySignalsPost200Response given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of V3VerifySignalsPost200Response
     * @throws IOException if the JSON string is invalid with respect to V3VerifySignalsPost200Response
     */
    public static V3VerifySignalsPost200Response fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, V3VerifySignalsPost200Response.class);
    }

    /**
     * Convert an instance of V3VerifySignalsPost200Response to an JSON string
     *
     * @return JSON string
     */
